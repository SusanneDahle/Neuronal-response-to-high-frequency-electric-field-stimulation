...
def run_simulation_neuron_models(freq, neurons, diam, upper_len, tstop, dt, cutoff,
                                 local_E_field=1, directory='/Users/susannedahle/Python/Simulation_data_ideal_models'):
    
    amp_data_file_path = os.path.join(directory, 'amp_data_ideal_neuron_models.npy')
    plot_data_file_path = os.path.join(directory, 'plot_data_ideal_neuron_models.npy')
